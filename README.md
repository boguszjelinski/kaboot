...
You can start with just one cab and one customer in two separate command line window:
```
javac OneCab.java
java OneCab 0 1
...
| DEMAND_FILE | taxi_demand.txt | CustomerGenerator | source of taxi requests, random generated by gendemand.py
